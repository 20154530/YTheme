    ...
    <form id="form1" name="form1" method="post">
      <table width="100%" style='padding:0;margin:0;' cellspacing='0' cellpadding='0' class="tableBorder">
        ...
        <tr>
          ...
          <td><p align="left">
              <textarea name="ftcode" type="text" id="ftcode" style="width:98%;"><?php echo $zbp->Config('um_blog')->ftcode;?></textarea>
            </p></td>
        ...
        <tr>
          ...
          <td><p align="left">
              <textarea name="beian" type="text" id="beian" style="width:98%;"><?php echo $zbp->Config('um_blog')->beian;?></textarea>
            </p></td>
