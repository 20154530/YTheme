...
<div class="post single">
	...
	<h6 class="post-footer">
		{$lang['msg']['author']}:{$article.Author.StaticName} | {$lang['msg']['category']}:{$article.Category.Name} | {$lang['yt_blog']['view']}:{$article.ViewNums} | {$lang['msg']['comment']}:{$article.CommNums}
	</h6>
</div>
