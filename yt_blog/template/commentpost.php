...
<div class="post" id="divCommentPost">
	<p class="posttop"><a name="comment">{if $user.ID>0}{$user.StaticName}{/if}{$lang['yt_blog']['add_reply']}:</a><a rel="nofollow" id="cancel-reply" href="#divCommentPost" style="display:none;"><small>{$lang['yt_blog']['cancel_reply']}</small></a></p>
...
{/if}
	...
	<p class="postbottom">{$lang['yt_blog']['reply_notice']}</p>
</div>