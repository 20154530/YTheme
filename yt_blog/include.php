...
function yt_blog_tags_set(&$template){
	global $zbp;
	$template->SetTags('yt_blog_tx',$zbp->Config('yt_blog')->tx);
	$template->SetTags('yt_blog_banner',$zbp->Config('yt_blog')->banner);
	$template->SetTags('yt_blog_explain1',$zbp->Config('yt_blog')->explain1);
	$template->SetTags('yt_blog_explain2',$zbp->Config('yt_blog')->explain2);
	$template->SetTags('yt_blog_thumbnail',$zbp->Config('yt_blog')->thumbnail);
	$template->SetTags('yt_blog_tag_num',$zbp->Config('yt_blog')->tag_num);
	$template->SetTags('yt_blog_qq',$zbp->Config('yt_blog')->qq);
	$template->SetTags('yt_blog_cntact_us',$zbp->Config('yt_blog')->cntact_us);
	$template->SetTags('yt_blog_keywords',$zbp->Config('yt_blog')->keywords);
    $template->SetTags('yt_blog_description',$zbp->Config('yt_blog')->description);
	$template->SetTags('yt_blog_share_switch',$zbp->Config('yt_blog')->share_switch);
	$template->SetTags('yt_blog_share',$zbp->Config('yt_blog')->share);
	$template->SetTags('yt_blog_seo',$zbp->Config('yt_blog')->seo);
	$template->SetTags('yt_blog_post_category',$zbp->Config('yt_blog')->post_category);
	$template->SetTags('yt_blog_page_subname',$zbp->Config('yt_blog')->page_subname);
}
